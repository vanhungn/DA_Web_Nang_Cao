<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="DA_Web_Nang_Cao.src.dangkygangnhap.login" %>
...
<body>
    ...
    <img src="google-icon.png" alt="Google Icon" style="height:16px; vertical-align:middle;" /> Đăng nhập với Google
</button>
                <button type="button" class="zalo">
     <img src="zalo.png" alt="zalo Icon" style="height:16px; vertical-align:middle;" /> Đăng nhập với zalo
                </button>
            </div>
        </div>
    </form>
