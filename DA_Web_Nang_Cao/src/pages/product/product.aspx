<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="DA_Web_Nang_Cao.src.pages.product.product" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="product.css?v=125" />
</head>
<body>
          ...
          <div>
            ...
            <div class="productBody">
                <div class="topProduct">
                    <span class="linkHome">TRANG CHỦ  >>  </span>
                                ...
                                <ItemTemplate>
                                    <div class="productItems">
                                        <div style="position:relative;width:100%;height:100%">
                                            ...
                                            <asp:Button runat="server" CssClass="buttonDetail" CommandArgument='<%# Eval("idItem")%>' CommandName="detailProduct" OnCommand="OnClickDetail" />
                                        </div>
