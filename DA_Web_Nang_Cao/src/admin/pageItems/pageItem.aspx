<%@ Page Language="C#" MasterPageFile="~/src/admin/masterAdmin/pageAdmin.master" AutoEventWireup="true" CodeBehind="pageItem.aspx.cs" Inherits="DA_Web_Nang_Cao.src.admin.pageItems.pageItem" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding-left: 50px; width: 78%; height: 100vh">
        <div class="boxSearchQuery">
            <asp:TextBox runat="server" ID="txt_searchItem" placeholder="Tìm kiếm mặt hàng..." CssClass="textBoxSearchItem" AutoPostBack="true" OnTextChanged="OnchangeListItem" ></asp:TextBox>
            <div class="boxSelect">
                ...
                <asp:DropDownList ID="d_status" runat="server" CssClass="form-controlArrange"  AutoPostBack="true"  OnSelectedIndexChanged="OnchangeListItem">
                    <asp:ListItem Text="Trạng thái" Value="" />
                    <asp:ListItem Text="Còn Hàng" Value="Còn hàng" />
                    <asp:ListItem Text="Hết Hàng" Value="Hết hàng" />
                </asp:DropDownList>
                 <asp:DropDownList ID="d_kindOf" runat="server" CssClass="form-controlArrange"  AutoPostBack="true"  OnSelectedIndexChanged="OnchangeListItem">
                    <asp:ListItem Text="Trạng thái" Value="" />
                    <asp:ListItem Text="Bột, Ngũ cốc" Value="Bột, Ngũ cốc" />
