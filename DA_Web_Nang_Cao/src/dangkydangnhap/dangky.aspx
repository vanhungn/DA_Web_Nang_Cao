<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dangky.aspx.cs" Inherits="DA_Web_Nang_Cao.src.dangkydangnhap.dangky" %>
    ...
    <div class="captcha-container">
        ...
        <asp:LinkButton ID="btnRefreshCaptcha" runat="server" OnClick="btnRefreshCaptcha_Click" CssClass="refresh-icon" ToolTip="Đổi mã">
            ...
            <div class="button-group">
                ...
                <asp:Button ID="btnReset" runat="server" Text="Làm lại" OnClientClick="document.getElementById('form1').reset();" OnClick="btnReset_Click" CausesValidation="false" UseSubmitBehavior="false" />
            </div>
